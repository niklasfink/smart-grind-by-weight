...
public:
    ...
    enum class EventType {
        ...
        AUTO_START_TOGGLE,
        AUTO_RETURN_TOGGLE,
        BASKET_DETECT_TOGGLE,
        BASKET_CAPTURE_SINGLE,
        BASKET_CAPTURE_DOUBLE,
        BASKET_TOLERANCE_SLIDER,
        BASKET_TOLERANCE_SLIDER_RELEASED,
        GRINDER_PURGE_MODE_RADIO_BUTTON,
        GRINDER_PURGE_AMOUNT_SLIDER,
        GRINDER_PURGE_AMOUNT_SLIDER_RELEASED,
        GRIND_FRESHNESS_HOURS_SLIDER,
        GRIND_FRESHNESS_HOURS_SLIDER_RELEASED,
        COAST_RATIO_SLIDER,
        COAST_RATIO_SLIDER_RELEASED,
